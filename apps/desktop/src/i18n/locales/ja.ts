...
export const JA_MESSAGES = {
  ...
  "settings.general.project_issue_language.label": "プロジェクト課題の言語",
  "settings.general.project_issue_language.description":
    "Project OSが課題を作成するときに使う言語を選択します。システムはOSの言語設定に従います。",
  "settings.general.project_issue_language.placeholder": "課題の言語を選択",
  ...
  "settings.about.update.title": "アップデート",
  "settings.about.update.description": "新しいアプリバージョンを手動で確認してインストールできます。",
  "settings.about.update.check": "更新を確認",
  "settings.about.update.checking": "確認中...",
  "settings.about.update.current": "最新バージョンを使用中です。",
  "settings.about.update.available": "{{version}} をインストールできます。",
  "settings.about.update.latest_version": "最新",
  "settings.about.update.download_progress": "ダウンロード",
  "settings.about.update.ready": "アップデートがインストールされました。再起動すると適用されます。",
