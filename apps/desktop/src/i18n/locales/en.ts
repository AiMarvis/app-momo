...
export const EN_MESSAGES = {
  ...
  "settings.general.project_issue_language.label": "Project issue language",
  "settings.general.project_issue_language.description":
    "Choose the language Project OS uses when creating issues. System follows your OS language.",
  "settings.general.project_issue_language.placeholder": "Select issue language",
  ...
  "settings.about.update.description": "Check for and install new app versions manually.",
  "settings.about.update.check": "Check for updates",
  "settings.about.update.checking": "Checking...",
  "settings.about.update.current": "You're on the latest version.",
  "settings.about.update.available": "Version {{version}} is available.",
  "settings.about.update.latest_version": "latest",
  "settings.about.update.download_progress": "Download",
  "settings.about.update.ready": "Update installed. Relaunch to apply it.",
