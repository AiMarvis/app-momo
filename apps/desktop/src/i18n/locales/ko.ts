...
export const KO_MESSAGES = {
  ...
  "settings.general.project_issue_language.label": "프로젝트 이슈 언어",
  "settings.general.project_issue_language.description":
    "Project OS가 이슈를 만들 때 사용할 언어를 선택해요. '시스템'은 OS 언어를 따라가요.",
  "settings.general.project_issue_language.placeholder": "이슈 언어 선택",
  ...
  "settings.about.update.title": "업데이트",
  "settings.about.update.description": "새 버전을 직접 확인하고 설치할 수 있어요.",
  "settings.about.update.check": "업데이트 확인",
  "settings.about.update.checking": "확인 중...",
  "settings.about.update.current": "최신 버전을 사용 중이에요.",
  "settings.about.update.available": "{{version}} 버전을 설치할 수 있어요.",
  "settings.about.update.latest_version": "최신 버전",
  "settings.about.update.download_progress": "다운로드",
  "settings.about.update.ready": "업데이트가 설치됐어요. 다시 실행하면 적용돼요.",
