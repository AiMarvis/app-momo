...
function ProjectIssueLanguageControl() {
  const languageOptions = [
    { value: "system", label: t("settings.appearance.language.system") },
    { value: "en", label: t("settings.appearance.language.en") },
    { value: "ko", label: t("settings.appearance.language.ko") },
  ...
  return (
    <div class="w-full max-w-56">
      <SettingsSelect
        options={languageOptions}
        value={settingsState.general.projectIssueLanguage}
        onChange={(value) =>
          setGeneralSetting("projectIssueLanguage", value as ProjectIssueLanguage)
        }
        placeholder={t("settings.general.project_issue_language.placeholder")}
      />
    </div>
  );
}
...
function GeneralSection() {
  return (
    ...
    >
      ...
      />
      <SettingsFieldRow
        label={t("settings.general.project_issue_language.label")}
        description={t("settings.general.project_issue_language.description")}
        control={<ProjectIssueLanguageControl />}
      />
      <SettingsFieldRow
        stacked
